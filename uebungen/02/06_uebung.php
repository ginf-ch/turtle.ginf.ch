        ...
        <ol>
            ...
            <li>
                <p>
                    ...
                    welches das <b>gleichseitige Dreieck</b> aus der folgenden Skizze zeichnet.
                </p>
                <div class="box my-5">
                    <div class="title is-size-6">Skizze</div>
                    <figure class="image is-256x256">
                        <img src="https://turtle.ginf.ch/uebungen/02/06_skizze.png" alt="Dreieck 200">
                    </figure>
                </div>
            </li>
            <li>
