        ...
        <ol>
            ...
            <li>
                <p>
                    ...
                    welches die <b>Pyramide</b> aus der folgenden Skizze zeichnet.
                </p>
                <div class="box my-5">
                    <div class="title is-size-6">Skizze</div>
                    <figure class="image is-256x256">
                        <img src="https://turtle.ginf.ch/uebungen/02/04_skizze.png" alt="Pyramide 50x50">
                    </figure>
                </div>
            </li>
            <li>
