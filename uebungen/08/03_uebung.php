...
$pythonFilename = "vier_quadrate.py";
...
<code></code>
<code></code>
<code>def<span class="has-text-grey-light">&sqcup;</span>quadrate():</code>
<code>&nbsp;&#8677;&nbsp;for<span class="has-text-grey-light">&sqcup;</span>_<span
            class="has-text-grey-light">&sqcup;</span>in<span class="has-text-grey-light">&sqcup;</span>range(4):</code>
...
<code></code></pre>
                ...
                $text = 'Vor und nach einer <b>Funktionsdefinition</b> werden <b>zwei Leerzeilen</b> notiert. Befindet sich die Funktionsdefinition unmittelbar nach einer anderen Funktionsdefinition, dann werden keine zusätzlichen Leerzeilen hinzugefügt. Also insgesamt zwei Leerzeilen, nicht vier Leerzeilen.';
                echoCleanCode($text);
                ?>
            </li>
            <li>
